...
mod tests {
    ...
    impl Scratch {
        fn new(name: &str) -> Self {
            let root = std::env::temp_dir().join(format!("kraken-pi-sessions-{name}"));
    ...
    fn sessions_are_matched_by_the_cwd_their_header_records() {
        ...
        scratch.write(
            "--home-pascal-Workspace-kraken--",
            "a.jsonl",
            &[
                header("a", "2026-07-22T14:05:18.076Z", "/home/pascal/Workspace/kraken"),
        ...
        let found = list_sessions(&scratch.root, "/home/pascal/Workspace/kraken", &HashSet::new());
