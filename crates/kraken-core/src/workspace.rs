...
mod tests {
    ...
    fn a_path_is_labelled_by_its_folder() {
        assert_eq!(abbreviation_for_path("/home/pascal/Workspace/kraken"), "KRA");
        assert_eq!(
    ...
    fn a_workspace_keeps_its_hue_across_runs() {
        let key = "/home/pascal/Workspace/kraken";
        ...
        assert_eq!(tile_hue("/home/pascal/Workspace/kraken"), 43);
