...
//! address means — is this object's and [`kraken_core::browser`]'s; the page
...
pub struct BrowserBridge {
    ...
    /// A fresh file under `~/.kraken/screenshots/` for the panel to save a
...
impl BrowserBridge {
    ...
    fn capture_path(&self) -> QString {
        let folder = kraken_core::state::config_dir().join("screenshots");
