...
//!
//! Everything that *is* a terminal lives in `kraken_core::terminal` — the pty, the
...
use kraken_core::terminal::keymap::KeyEvent;
use kraken_core::terminal::{CursorStyle, Grid, RenderState, SelectionMode, Terminal};
use kraken_core::theme::{terminal_theme, Rgb, DEFAULT_THEME};
use kraken_core::typography::terminal as sizes;
...
pub struct TerminalBridge {
    ...
    /// `kraken_core::terminal::keymap` speaks Qt's constants, so QML can hand over
